...
class BookingTest extends TestCase
{
    ...
    public function testMakeInterval(){
        ...
        $s->setDays('2015-11-25,2015-11-26,2015-11-27,2015-11-28,2015-11-29,2015-11-30');

        $this->assertEquals($s->getDays(),$b->makeInterval()->getDays());
